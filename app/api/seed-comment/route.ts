...
const PERSONA_VOICE: Record<string, string> = {
  seouldrifter88:   'Casual American. Short. Uses "ngl", "tbh", "honestly". Doesn\'t overthink.',
  fromageseoul:     'Warm and thoughtful. Real. Genuine. Occasionally adds a personal connection.',
  propercuppa:      'Dry British wit. Concise. Slight sarcasm that reads as sincere.',
  pixelyuki:        'Enthusiastic and genuinely curious. Compares to Japan sometimes. Warm.',
  pho4seoul:        'Blunt and practical. Gets to the point. Real prices or tips when relevant.',
  chai2soju:        'Reflective. "Honestly", "I feel like". Thoughtful, sometimes overthinks.',
  busanbeats:       'Real and warm. Doesn\'t sugarcoat. Friendly but direct.',
  urbanwei:         'Analytical but accessible. Notices patterns. Brief.',
  maprotom:         'Straightforward. Casual. Short. "for real tho".',
  emlb:             'Dry Australian humor. Self-aware. "heaps", "no worries".',
  dimakr:           'Concise and observational. Occasionally wry.',
  twopassports:     'Self-aware humor about being between cultures. Warm.',
  ramyeonirl:       'Internet-native. Tier list energy. Casual and funny.',
  seoulbound99:     'Relatable. "at this point", "genuinely". Humor about Korea chaos.',
  klifediary:       'Dry, slightly clinical then surprised. German directness.',
  itaewondiary:     'Expressive. "omg", enthusiastic. Fashion/aesthetic references.',
  seoulnoodlekid:   'Food-obsessed but real about expat life. Warm opinions.',
  stillxpat:        'Openly confused sometimes. Self-deprecating. "help?" energy.',
  hannahhd:         'Creative and observational. Notices small details. Warm.',
  accidentalkorean: 'Wry "how did I end up here" energy. Warm and domestic.',
}
